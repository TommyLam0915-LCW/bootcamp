package customer.dse.Stringbulider;
...
public class DemoSB {
  ...
  public static void main(String[] args) {
    ...
    String result10 = sb4.toString().replace("b","y"); //!!cabxbbdddccc
    System.out.println(result10);//!!cayxyydddccc
    System.out.println(sb4.toString()); //!!cabxbbdddccc
