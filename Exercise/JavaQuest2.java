...
public class JavaQuest2 {
  public static void main(String[] args) {
    ...
    if (year1 % 4 == 0 && ((year1 % 100 != 0 || year1 % 400 == 0))) {
      System.out.println(year1 + "is a leap year."); // code here ..
    } ;

    int year2 = 2020;
    // same as the above, but it will print out.
    if (year2 % 4 == 0 && ((year2 % 100 != 0 || year2 % 400 == 0))) {
      System.out.println(year2 + "is a leap year."); // code here ..
    } else {
    ...
    if (year3 % 4 == 0 && year3 % 100 != 0 || year3 % 400 == 0) {
      System.out.println(year3 + "is a leap year."); // code here ..
    } else {
    ...
    if (year5 % 4 == 0 && ((year5 % 100 != 0 && year5 % 400 == 0))) {
      System.out.println(year5 + "is a leap year."); // code here ..
    };
    }
  }
